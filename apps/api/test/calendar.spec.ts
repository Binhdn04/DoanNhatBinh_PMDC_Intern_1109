...
describe('reportingPeriods', () => {
  ...
  it('handles a DST timezone without changing Monday-Sunday boundaries', () => {
    const periods = reportingPeriods('2026-03-08', '2026-03-09', 'America/New_York');
    expect(periods).toHaveLength(2);
    expect(periods.map(period => [period.weekStart, period.weekEnd])).toEqual([['2026-03-02', '2026-03-08'], ['2026-03-09', '2026-03-15']]);
  });
});
